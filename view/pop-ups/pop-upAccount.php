    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="modal-title">Entre ou Crie uma conta</h2>
            ...
            <span class=""><p> Caso não tenha uma conta, cadastre-se clicando <a href="" id="createAcc" data-bs-toggle="modal" data-bs-target="#pop-upCreateAccount">aqui</a>.</p></span>
            </div>
        </div>
    </div>
</div>