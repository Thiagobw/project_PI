...
<body>
    ...
    <!-- featured products -->
    <form method="POST" action="/project_PI/control/control_cart.php" name="form_cart">
        <div class="container-fluid mt-3 mb-3">
            ...
            <div class="row justify-content-around" id="row_products_animate1">
                <div class="col-11 col-sm-8 col-md-5 col-lg-5 col-xl-3 mt-3 mb-3 center prod shadow">
                    ...
                    <!-- <div>
                        <button class="btn btn-primary form-control" type="submit" name="product" style="background-color: red;" value="1">
                            Adicionar
                        </button>
                        <input type="number" name="quantity" placeholder="quantidade" value="1" min="0">
                    </div> -->
                </div>
