...
$sizes = seeSizeAvaliable($_SESSION['product_id']); //DB query retrieve format
$prod = getProduct($_SESSION['product_id']); //Model/object retrieve format
            ...
            <div class="cart-item">
                ...
                <div class="row cart-row">
                    ...
                    <div class="cart-row-cell amount">
                        <p>R$ <span><?php echo $prod->getPrice()* $_SESSION['quantity']; ?> cada</span></p>
                    </div>
                </div>
            </div>
